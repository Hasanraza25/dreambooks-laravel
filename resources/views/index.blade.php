        ...
        <section class="upcoming-release">
            ...
            <div class="upcoming-slider">
                <div class="container">
                        ...
                        <div class="release-book-slider">
                            @forelse($upcoming_books as $upcoming_book)
                                <div class="item">
                                    <div class="detail">
                                        <h5><a
                                                href="{{ Route('book.show', $upcoming_book->slug) }}">{{ Str::limit($upcoming_book->title, 50, '...') }}</a>
                                        </h5>
                                    ...
                                    <div class="detail-img">
                                        @if ($upcoming_book->book_img == 'No image found')
                                            <img src="/uploads/no-img.jpg" width="112" height="156"
                                                alt="No image found">
                                        @else
                                            <img src="/uploads/{{ $upcoming_book->book_img }}" width="112" height="156"
                                                alt="{{ $upcoming_book->title }}">
                                        @endif
                                    </div>
                                </div>
                            @empty
                    ...
                    <!-- Thumbs -->
                    <div class="release-thumb-holder md:block hidden">
                        <ul id="release-thumb" class="release-thumb">
                            @foreach ($upcoming_books as $key => $upcoming_book)
                                <li>
                                    <a data-slide-index="{{ $key }}"
                                        href="{{ Route('book.show', $upcoming_book->slug) }}">
                                        <span>{{ Str::limit($upcoming_book->title, 8, '...') }}</span>
                                        @if ($upcoming_book->book_img == 'No image found')
                                            <img src="/uploads/no-img.jpg" width="94" height="122"
                                                alt="No image found">
                                        @else
                                            <img src="/uploads/{{ $upcoming_book->book_img }}" width="94"
                                                height="122" alt="{{ $upcoming_book->title }}">
                                        @endif
                                        <img class="b-shadow" src="/assets/images/upcoming-release/b-shadow.png"
                                            alt="">
                                        ...
                                        <div class="product-box">
                                            <div class="product-img">
                                                @if ($downloaded_book->book_img == 'No image found')
                                                    <img src="/uploads/no-img.jpg" width="132" height="197"
                                                        alt="No image found">
                                                @else
                                                    <img src="/uploads/{{ $downloaded_book->book_img }}" width="132"
                                                        height="197" alt="{{ $downloaded_book->title }}">
                                                @endif
                                                <ul class="product-cart-option position-center-x">
                                                    <li><a href="{{ $downloaded_book->facebook_id }}" target="_blank"><i
                                                                class="fa fa-facebook"></i></a></li>
                                                    <li><a href="{{ $downloaded_book->twitter_id }}" target="_blank"><i
                                                                class="fa fa-twitter"></i></a></li>
                                                    <li><a href="{{ $downloaded_book->linkedin_id }}" target="_blank"><i
                                            ...
                                            <div class="product-detail">
                                                ...
                                                <h5><a
                                                        href="{{ Route('book.show', $downloaded_book->slug) }}">{{ $downloaded_book->title }}</a>
                                                </h5>
                                                ...
                                                <div class="aurthor-detail">
                                                    <span><img src="/uploads/{{ $downloaded_book->author->author_img }}"
                                                            width="34" height="34"
                                                            alt="">{{ $downloaded_book->author->title }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="recomend-slider">
                    @forelse($recommended_books as $recommended_book)
                        ...
                        <div class="item">
                            ...
                            @else
                                <img src="/uploads/{{ $recommended_book->book_img }}" width="109" height="150"
                        ...
                        <div class="col-lg-9 col-sm-12">
                            <div class="collection">
                                ...
                                <div class="sec-heading">
                                    ...
                                    <a class="view-all" href="#">View All<i
                                                ...
                                                <div class="s-product">
                                                    <div class="s-product-img">
                                                        @if ($book->book_img == 'No image found')
                                                            <img src="/uploads/no-img.jpg" width="145" height="209"
                                                                alt="No image found">
                                                        @else
                                                            <img src="/uploads/{{ $book->book_img }}" width="145"
                                                                height="209" alt="{{ $book->title }}">
                                                        @endif
                                                        <div class="s-product-hover"></div>
                                                    </div>
                                                    <h6><a
                                                            href="{{ Route('book.show', $book->slug) }}">{{ Str::limit($book->title, 15, '...') }}</a>
                                                    </h6>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-12">
                        <div class="aurthor-img">
                            ...
                            @else
                                <img src="/uploads/{{ $author_feature->author_img }}" width="243" height="344"
                                    alt="{{ $author_feature->title }}">
                            @endif
                        </div>
                    </div>
                    <!-- Aurthor -->
                        ...
                        <div id="timeline">
                            <ul id="issues">
                                <li id="1985">
                                    <div class="text-box">
                                        <div class="left-box">
                                            <h5><span class="theme-color">{{ $author_feature->title }}</span>
                                                {{ $author_feature->designation }}</h5>
                                            <p>{{ $author_feature->description }}</p>
                                            <div class="follow">
                                                <ul class="social-icons">
                                                    <li>Follow us</li>
                                                    <li><a class="facebook" href="{{ $author_feature->facebook_id }}"
                                                            target="_blank"><i class="fa fa-facebook"></i></a></li>
                                                    <li><a class="twitter" href="{{ $author_feature->twitter_id }}"
                                                            target="_blank"><i class="fa fa-twitter"></i></a></li>
                                                    <li><a class="youtube" href="{{ $author_feature->youtube_id }}"
                                                            target="_blank"><i class="fa fa-youtube-play"></i></a></li>
                                                    <li><a class="pinterest" href="{{ $author_feature->pinterest_id }}"
                                                ...
                                                @if ($key < 3)
                                                    <li>
                                                        @if ($author_book->book_img == 'No image found')
                                                            <img src="/uploads/no-img.jpg" width="89" height="119"
                                                                alt="No image found">
                                                        @else
                                                            <img src="/uploads/{{ $author_book->book_img }}"
                                                                width="89" height="119"
                                                                alt="{{ $author_book->title }}">
                                                        @endif
                                                        <a href="{{ Route('book.show', $author_book->slug) }}">
                                                            <h6 class="name">
                                                                {{ Str::limit($author_book->title, 8, '...') }}</h6>
                                                        </a>
                                                    </li>
                                                @endif
                                            @endforeach
                                    ...
                                    <li>
                                        <div class="gallery-figure">
                                            @if ($gallery->media_img == 'No image found')
                                                <img src="/uploads/no-img.jpg" width="242" height="187"
                                                    alt="No image found">
                                            @else
                                                <img src="/uploads/{{ $gallery->media_img }}" width="242"
                                                    height="187" alt="{{ $gallery->title }}">
                                            @endif
