			...
			<div class="container">
				...
				<div class="release-book-detail h-white p-white">
						<div class="release-book-slider">
						  @forelse($upcoming_books as $upcoming_book)  
                            <div class="item">
                                <div class="detail">
                                    <h5><a href="{{ Route('book.show', $upcoming_book->slug) }}">{{ Str::limit($upcoming_book->title, 50, '...') }}</a></h5>
                                ...
                                <div class="detail-img">
									@if($upcoming_book->book_img == 'No image found')
										<img src="/uploads/no-img.jpg" width="112" height="156" alt="No image found">
									@else
				...
				<div class="release-thumb-holder">
					...
					@foreach($upcoming_books as $key => $upcoming_book)
                      <li>
                          <a data-slide-index="{{ $key }}" href="{{ Route('book.show', $upcoming_book->slug) }}">
                              <span>{{ Str::limit($upcoming_book->title, 8, '...') }}</span>
                              @if($upcoming_book->book_img == 'No image found')
								<img src="/uploads/no-img.jpg" width="94" height="122" alt="No image found">
								@else
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <div class="aurthor-detail">
                                            <span><img src="/uploads/{{ $downloaded_book->author->author_img }}" width="34" height="34" alt="">{{ $downloaded_book->author->title }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
									...
									<div class="text-box">
										...
										<ul class="s-related-products">
											...
											<li>
                                                ...
                                                @endif
                                                <a href="{{ Route('book.show', $author_book->slug) }}"><h6 class="name">{{ Str::limit($author_book->title, 8, '...') }}</h6></a>  
											</li>
											@endif
											@endforeach
										</ul>
