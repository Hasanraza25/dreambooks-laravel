      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/uploads/{{ Auth::user()->user_img }}" width="160" height="160" class="user-image" alt="{{ Auth::user()->name }}}">
              <span class="hidden-xs">{{ Auth::user()->name }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="/uploads/{{ Auth::user()->user_img }}" width="160" height="160" class="img-circle" alt="{{ Auth::user()->name }}}">
    ...
    <section class="sidebar">
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
      	<ul class="sidebar-menu" data-widget="tree">
            ...
            <li class=" treeview {{ Request::is('admin/category') || Request::is('admin/category/create') ? 'active' : null }}">
                <a href="#">
            ...
            <li class="treeview {{ Request::is('admin/author') || Request::is('admin/author/create') ? 'active' : null }}">
                <a href="#">
            ...
            <li class="treeview {{ Request::is('admin/book') || Request::is('admin/book/create') ? 'active' : null }}">
                <a href="#">
            ...
            <li class="treeview {{ Request::is('admin/media') || Request::is('admin/media/create') ? 'active' : null }}">
                <a href="#">
            ...
            <li class="treeview {{ Request::is('admin/team') || Request::is('admin/team/create') ? 'active' : null }}">
                <a href="#">
